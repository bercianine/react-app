...
const sectionTwo = [shapes, 'Make your own lists and watch away.', 'Join DISPLAY, make an account so you can create watchlists and easily access all the content you selected. No hustle, just sit back and enjoy.']
...
function App() {
  return (
    <>
      ...
      <SectionImage image={sectionTwo[0]} heading={sectionTwo[1]} text={sectionTwo[2]} />
    </>
  )
}
